<template>
  <div class="language-chooser relative inline-block w-24">
    <button
      ...
      class="flex items-center justify-between w-full space-x-2 px-2 rounded-lg ring-1 ring-inset ring-gray-200/50 dark:ring-gray-700/50 sm:hover:ring-cyan-300 sm:dark:hover:ring-cyan-600 transition-all duration-200"
    >
