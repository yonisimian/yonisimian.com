<template>
  <div
    class="inline-flex text-white bg-black bg-opacity-20 border-none rounded-full p-2 overflow-hidden"
    :class="{
      'bg-green bg-opacity-80 stretched': isSharing
    }"
  >
...
<style scoped>
.inline-flex {
  transition: padding-right 1s cubic-bezier(0.4, 0, 0.2, 1), background 1s;
